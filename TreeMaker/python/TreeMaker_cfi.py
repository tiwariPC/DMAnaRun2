...
#    THINJets=cms.InputTag("slimmedJets"),
    ...
    THINjecUncName   = cms.string('Spring16_25nsV10_MC_Uncertainty_AK4PFchs.txt'),
...
#    FATJets=cms.InputTag("slimmedJetsAK8"),
    ...
    FATjecUncName        = cms.string('Spring16_25nsV10_MC_Uncertainty_AK8PFchs.txt'),
    ...
    ADDjecUncName        = cms.string('Spring16_25nsV10_MC_Uncertainty_AK8PFchs.txt'),
...
#    AK4PuppiJets=cms.InputTag("slimmedJetsPuppi"),
    ...
    AK4PuppijecNames          = cms.vstring(
        'Spring16_25nsV10_MC_L2Relative_AK4PFPuppi.txt',
        'Spring16_25nsV10_MC_L3Absolute_AK4PFPuppi.txt'
        ),
    AK4PuppijecUncName        = cms.string('Spring16_25nsV10_MC_Uncertainty_AK4PFPuppi.txt'),
    ...
    AK8PuppijecUncName        = cms.string('Spring16_25nsV10_MC_Uncertainty_AK8PFPuppi.txt'),
    ...
    CA15PuppijecUncName        = cms.string('Spring16_25nsV10_MC_Uncertainty_AK8PFPuppi.txt'),
