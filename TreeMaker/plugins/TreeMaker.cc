...

{
  ...
  if( fillMetInfo_ )
    {
      ...
      patMetTree_->genMetToken     = consumes<pat::MET>(iConfig.getParameter<edm::InputTag>("mets"));
  ...
  if( fillFilterInfo_ ) 
      ...
      if( fillGenInfo_ ) 
    {
      ...
      genInfoTree_->genMETToken              = consumes<reco::GenMETCollection>(edm::InputTag("genMet"));
